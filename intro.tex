...
By simulating a deterministic lateral displacement microfluidic chip \todo{cite what this is}, one can optimize the device geometry through simulation and avoid the typical expensive trial-and-error design process through manufacturing \cite{kabacaouglu2019sorting}.
...
In summary, in order to faithfully model microcirculation through capillaries, our model must:
\begin{itemize}
