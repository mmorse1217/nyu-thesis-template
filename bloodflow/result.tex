...
\begin{minipage}[b]{0.4\textwidth}
    %\hspace*{-.05\linewidth}\includegraphics[angle=0,width=.3\linewidth]{figs/ttorus2_convergence_setup.png}
...
%\begin{figure}[!htb]
%  \subfloat[$t=0$\label{sfg:shear-snap1}]{\framebox(52,35){\includegraphics[width=52pt,height=35pt]{shear1}}}
%  \hspace{1pt}
%  \subfloat[$t=5$\label{sfg:shear-snap2}]{\framebox(52,35){\includegraphics[width=52pt,height=35pt]{shear2}}}
%  \hspace{1pt}
%  \subfloat[$t=20$\label{sfg:shear-snap3}]{\framebox(52,35){\includegraphics[width=52pt,height=35pt]{shear3}}}
%  \hspace{1pt}
%  \subfloat[$t=25$\label{sfg:shear-snap4}]{\framebox(52,35){\includegraphics[width=52pt,height=35pt]{shear5}}}
